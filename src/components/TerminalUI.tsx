...
export const TerminalUI: React.FC<TerminalUIProps> = ({ children, className, onClose }) => {
  ...
  return (
    <div className={cn(
      "fixed inset-0 md:inset-auto md:bottom-6 md:right-6 w-full h-full md:w-[400px] md:h-[500px] bg-[#1A1A1A] border border-white/10 shadow-2xl flex flex-col z-[10000] overflow-hidden md:rounded-sm backdrop-blur-md",
