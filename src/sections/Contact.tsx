...
export default function Contact() {
  ...
  return (
    <section 
      ref={sectionRef} 
      id="contact"
      className="section-pinned bg-[#0B0B0D] z-[70] flex items-center justify-center"
    >
      {/* Decorative Element */}
      <div 
        ref={decorRef}
      ...
      >
        <div className="w-20 md:w-32 h-20 md:h-32 border border-lime/20 relative">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2 h-2 bg-lime"></div>
        </div>
      </div>
      ...
      >
        <h2 className="text-[clamp(32px,10vw,64px)] md:text-[clamp(40px,4vw,64px)] font-bold text-[#F4F4F5] leading-[0.95] mb-4 md:mb-6">
          Let's build<br />something.
        </h2>
        <div className="w-[30vw] md:w-[15vw] h-px line-primary mb-6 md:mb-8"></div>
        <p className="text-[#A7A7AA] text-base md:text-lg leading-relaxed mb-8 md:mb-10 max-w-[90vw] md:max-w-[30vw]">
        ...
        <div className="space-y-3 md:space-y-4">
          <a 
            ...
            className="group flex items-center gap-3 md:gap-4 text-[#F4F4F5] hover:text-lime transition-colors"
          >
      ...
      >
        <div className="relative w-full h-full border border-white/20 p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Name */}
            <div>
              <label className="block font-mono text-xs uppercase tracking-[0.14em] text-[#A7A7AA] mb-3">
                Name
              </label>
              <input 
                type="text"
                ...
                className="w-full bg-transparent border-b border-white/20 py-3 text-[#F4F4F5] focus:border-lime focus:outline-none transition-colors"
            ...
            <div>
              ...
              <textarea 
                ...
                className="w-full bg-transparent border-b border-white/20 py-3 text-[#F4F4F5] focus:border-lime focus:outline-none transition-colors resize-none"
                rows={4}
            ...
            <button 
              type="submit"
              className="group flex items-center gap-3 px-8 py-4 bg-lime text-[#0B0B0D] font-mono text-sm uppercase tracking-[0.14em] font-medium hover:bg-white transition-colors mt-8"
            >
              Send message
